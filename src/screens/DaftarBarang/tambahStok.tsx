...
export default function TambahStok(props) {
  ...
  return (
    <View style={[styles.FormKategori, styles.shadow]} onLayout={event => setLayout(event.nativeEvent.layout)} ref={containerRef}>
      <View style={styles.GroupKategori}>
        <Text style={styles.TopLabel}>Tambah Stok Barang</Text>
        ...
        <View style={styles.TitleBox}>
          <Text style={[styles.ItemLabel, {width: '25%'}]}>Tambah Stok</Text>
          <Text style={styles.ItemLabel}>:</Text>
          <TextInput
      ...
      <Pressable
        ...
        onPress={() => props.setModalAddProduct(!props.setModalAddProduct)}
      >
